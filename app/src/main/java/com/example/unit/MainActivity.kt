...
fun UnitConvertor(){
    ...
    fun conversion(conversionFactor: Double){
        result = ((inValue.toDouble()*conversionFactor*10000).toInt()).toDouble()/1000
    ...
    Column(
        ...
        Spacer(modifier = Modifier.height(16.dp))
            OutlinedTextField(value = inValue, onValueChange = {inValue=it
